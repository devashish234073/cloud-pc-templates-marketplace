...
# Setup and Run Script for Termux - Run agents directly on Android
# This script installs dependencies via pkg, and runs all agents

set -e  # Exit on any error

echo "=========================================="
echo "Cloud PC Templates Agents Setup for Termux"
echo "=========================================="

# Check if running on Termux
if [ ! -d "$PREFIX" ]; then
    echo "Error: This script requires Termux (Android terminal emulator)"
    echo "Install Termux from: https://github.com/termux/termux-app"
    exit 1
fi

# Step 1: Update package manager
echo "Step 1: Updating Termux package manager..."
pkg update -y

# Step 2: Install system dependencies
echo "Step 2: Installing system dependencies..."
pkg install -y curl git unzip ca-certificates openssl
...
echo ""
echo "=========================================="
echo "Starting Agents in Termux..."
echo "=========================================="
...
echo ""
echo "=========================================="
echo "All agents started in Termux"
echo "=========================================="
echo "Agent ports available:"
echo "  - Port range: 3000-3100"
echo "  - Angular app: 4200"
echo ""
echo "NOTE: On Termux/Android, you may need to use your device's IP address"
echo "to access the services from a browser (e.g., http://YOUR_IP:3000)"
echo ""
